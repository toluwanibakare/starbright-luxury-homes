            ...
            <div className="container-premium px-5 sm:px-8 lg:px-12 py-12 space-y-12">
                    ...
                    >
                        ...
                        <div className="relative max-w-4xl">
                            ...
                            <p className="text-sm sm:text-base text-muted-foreground mt-5 leading-8">
                                At Star Bright Real Estate and Properties, we believe that owning genuine real estate should not be a privilege reserved for a few ΓÇö it should be an opportunity available to every Nigerian and every investor seeking value, security, and long-term wealth.
                            </p>
                ...
                >
                    <motion.div variants={fadeUp} className="relative rounded-2xl overflow-hidden aspect-[4/3] bg-muted">
                        <Image
                            src="/founders.jpeg"
                            alt="Dr. Oluwadamilola Adenike & Amb. Tunde Busari ΓÇö Founders, Starbright Real Estate"
                            fill
                    ...
                    <motion.div custom={1} variants={fadeUp} className="premium-card p-6 sm:p-8">
                        ...
                        <p className="text-sm sm:text-base text-muted-foreground mt-4 leading-8">
                            Under their leadership, Star Bright Real Estate and Properties has grown into a trusted partner for buyers, sellers, and investors across Nigeria ΓÇö offering everything from verified land and houses to commercial assets, construction, and property management.
                        </p>
                    </motion.div>
                </motion.section>
